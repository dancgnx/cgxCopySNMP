...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'cgxCopySNMP')
    custom_group.add_argument("--s_element", help="Name of the element (claimed device) to copy from",
                              default=None, action="store",dest="s_element")
    ...
    custom_group.add_argument("--list", help="list the current config of the Source device",
                              default=None, action="store_true",dest="list")
    custom_group.add_argument("--element_file", type=argparse.FileType('r'), help="A file with a list of target elements (assined devices). One device per line", default=None, action="store",dest="elements_file")
    custom_group.add_argument("--snmp_file", type=argparse.FileType('r'),help="A file with SNMP config using YAML format. Use --list to get an example from already configured element", default=None, action="store",dest="snmp_file")
